...
/**
 * Uniswap v3 WETH/USDC (Arbitrum) rewards-only adapter.
 *
 * Tracks only claimable USDC fees/rewards from the NFT position and ignores LP principal.
 */
export class UniswapV3WethUsdcArbitrumRewardsAdapter extends BaseProtocolAdapter {
  readonly protocolKey = 'uniswap-v3-weth-usdc-arbitrum-rewards' as const;
  readonly protocolName = 'Uniswap v3 WETH/USDC (Arbitrum)';
